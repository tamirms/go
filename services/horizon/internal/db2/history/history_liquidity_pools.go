...
func (i *operationLiquidityPoolBatchInsertBuilder) Add(operationID int64, internalID FutureID) error {
...
func (i *transactionLiquidityPoolBatchInsertBuilder) Add(transactionID int64, internalID FutureID) error {
	return i.builder.Row(map[string]interface{}{
